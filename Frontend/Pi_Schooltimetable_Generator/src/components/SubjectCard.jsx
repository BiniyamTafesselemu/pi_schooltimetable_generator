...
export default function SubjectCard({Subject, Label}){
    ...
    return(
        <div className="text-left">
            <h3>{Label}</h3>
            <div className='bg-[#f1f1f1] flex flex-col p-1 border-[0.01rem] border-solid border-[#8C5FFF] w-[40rem]'>
                <div className="flex justify-end">
                    ...
                    <EditSubject open={isOpen} onClose={()=> setIsOpen(false)} sectionCatagory={Subject.SectionCategory} subjectName={Label}/>
                </div>
                <h4 className='text-5xl pl-3'>Section category {Subject.SectionCategory}</h4>
