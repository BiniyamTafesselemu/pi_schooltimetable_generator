...
export default function EditSubject({open, onClose, subjectName, Load, sectionCatagory}) {
    ...
    const [values, setValues] = useState(
        {
            ...
            SectionCategory: sectionCatagory,
            Load: Load
        }
    )
    ...
    const handleInput = (event) =>{
        ...
        console.log(values.subjectName+" "+values.SectionCategory+" "+values.Load+" ");
    }
        ...
        <>
            ...
            <div style={MODAL_STYLES}>
                ...
                <form action='' onSubmit={handleSubmit}>
                    ...
                    {
                            (error.subjectName === "")?
                            (<div className=' flex flex-col'><TextInput id="base" type="text" sizing="md" placeholder={subjectName} value={values.subjectName} name='subjectName' onChange={handleInput}/></div>):
                            (<div className=' flex flex-col'><TextInput id="base" type="text" sizing="md" placeholder={subjectName} value={values.subjectName} name='subjectName' onChange={handleInput} color= 'failure'
                                helperText={
                                    <>
                        ...
                        {
                            (error.Load === "")?
                            (<div className=' flex flex-col'><TextInput id="base" type="text" sizing="md" placeholder={Load} value={values.Load} name='Load' onChange={handleInput}/></div>):
                            (<div className=' flex flex-col'><TextInput id="base" type="text" sizing="md" placeholder={Load} value={values.Load} name='Load' onChange={handleInput} color= "failure"
                                helperText={
                                    <>
                    ...
                    </div>
                    {
                        ...
                        (<Select id="countries" placeholder="Section Category" name='SectionCategory' onChange={handleInput} className='m-2' value={values.SectionCategory}>
                            {
                        ...
                        (<Select id="countries" placeholder="Section Category" name='SectionCategory' onChange={handleInput} color= "failure" className='m-2' value={values.SectionCategory}
                            helperText={
                                    <>
                                        <span className="font-medium">Oops!</span> {error.Load}
                                    </>
