    ...
    <div className='bg-[#f1f1f1] border-[0.1rem]  border-solid border-[rgb(167,115,222)] md:w-[40rem] p-1 m-5 rounded-xl' id={'SectionCard'+index}>
        <div className='flex flex-row justify-end'>
            <button onClick={()=> setIsOpen(true)}>
                <svg class='w-8 h-8 text-[#5E469C] hover:text-black dark:text-white' aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
